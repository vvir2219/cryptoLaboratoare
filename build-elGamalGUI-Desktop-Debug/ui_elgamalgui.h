...
public:
    ...
    void setupUi(QMainWindow *ElGamalGui)
    {
        ...
        button_encode->setGeometry(QRect(10, 310, 89, 28));
        button_decode = new QPushButton(centralWidget);
        button_decode->setObjectName(QString::fromUtf8("button_decode"));
        button_decode->setGeometry(QRect(110, 310, 89, 28));
        text_input = new QTextEdit(centralWidget);
        text_input->setObjectName(QString::fromUtf8("text_input"));
        text_input->setGeometry(QRect(10, 30, 561, 271));
        input_key_name = new QLineEdit(centralWidget);
        input_key_name->setObjectName(QString::fromUtf8("input_key_name"));
        input_key_name->setGeometry(QRect(180, 0, 113, 28));
    ...
    void retranslateUi(QMainWindow *ElGamalGui)
    {
        ...
        input_key_name->setPlaceholderText(QApplication::translate("ElGamalGui", "key name", nullptr));
    } // retranslateUi
